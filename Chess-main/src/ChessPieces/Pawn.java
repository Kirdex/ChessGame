...
public class Pawn extends ChessPiece{
	public static String name = "Pawn";		//Piece Name
	public static int materialWorth = 1;	//How much the piece is worth

	private boolean movedTwoUnitsUp;		//Keep track of whether the Pawn moved Two Units Up last turn.
